...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move HYPER_BEAM,   EFFECT_HYPER_BEAM,        150, NORMAL,        SPECIAL,   90, 10,   0
	...
	move MIND_READER,  EFFECT_LOCK_ON,             0, NORMAL,        STATUS,   100, 10,   0
	...
	move AEROBLAST,    EFFECT_NORMAL_HIT,        100, FLYING,        SPECIAL,   95, 10,   0
	...
	move DESTINY_BOND, EFFECT_DESTINY_BOND,        0, GHOST,         STATUS,   100, 10,   0
	move PERISH_SONG,  EFFECT_PERISH_SONG,         0, NORMAL,        STATUS,   100, 10,   0
	move ICY_WIND,     EFFECT_SPEED_DOWN_HIT,     55, ICE,           SPECIAL,   95, 15, 100
	move DETECT,       EFFECT_PROTECT,             0, FIGHTING,      STATUS,   100, 10,   0
	...
	move GIGA_DRAIN,   EFFECT_LEECH_HIT,          60, GRASS,         SPECIAL,  100, 10,   0
	...
	move MEAN_LOOK,    EFFECT_MEAN_LOOK,           0, NORMAL,        STATUS,   100, 10,   0
	move ATTRACT,      EFFECT_ATTRACT,             0, NORMAL,        STATUS,   100, 15,   0
	move SLEEP_TALK,   EFFECT_SLEEP_TALK,          0, NORMAL,        STATUS,   100, 10,   0
	move HEAL_BELL,    EFFECT_HEAL_BELL,           0, NORMAL,        STATUS,   100, 10,   0
	...
	move SACRED_FIRE,  EFFECT_SACRED_FIRE,       100, FIRE,          PHYSICAL,  95, 10,  50
	...
	move ENCORE,       EFFECT_ENCORE,              0, NORMAL,        STATUS,   100, 10,   0
	...
	move CROSS_CHOP,   EFFECT_NORMAL_HIT,        100, FIGHTING,      PHYSICAL,  80, 10,   0
	...
	move DRAININGKISS,   EFFECT_LEECH_HIT,          75, FAIRY,         SPECIAL,  100, 10,  0 
