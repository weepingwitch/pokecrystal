...
TimeFishGroups:
	...
	db SQUIRTLE,    20,  TOTODILE,    20 ; 4
	db GOLDEEN,    40,  GOLDEEN,    40 ; 5
	db POLIWAG,    20,  DRATINI,    20 ; 6
	db POLIWAG,    40,  DRATINI,    40 ; 7
	db POLIWAG,    20,  DRATINI,    20 ; 8
	db POLIWAG,    40,  DRATINI,    40 ; 9
