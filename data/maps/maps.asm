...
MapGroup_Dungeons:
	...
	map SafariZone2F, TILESET_JOHTO, ROUTE, LANDMARK_FUCHSIA_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_WHIRL_ISLANDS
	map SafariZone, TILESET_PARK, ROUTE, LANDMARK_FUCHSIA_CITY, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map VictoryRoad, TILESET_CAVE, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map PokemonMansion, TILESET_FACILITY, DUNGEON, LANDMARK_CINNABAR_ISLAND, MUSIC_TIN_TOWER, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map UnderPathJohto, TILESET_CAVE, CAVE, LANDMARK_ROUTE_30, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map UnderPath1F, TILESET_CAVE, CAVE, LANDMARK_SECRET_TUNNEL, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map UnderPath2F, TILESET_ICE_PATH, CAVE, LANDMARK_SECRET_TUNNEL, MUSIC_VICTORY_ROAD, FALSE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
...
MapGroup_Pewter:
	...
	map PewterMuseum, TILESET_FACILITY, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
