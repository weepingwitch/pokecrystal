...
LtSurgeGroup:
	...
	db 48, RAICHU,  MAGNET,   THUNDER_WAVE, QUICK_ATTACK, THUNDERBOLT, THUNDER
	db 47, LANTURN, GOLD_BERRY, TOXIC, SPARK, TAKE_DOWN, SUPERSONIC
...
SabrinaGroup:
	...
	db 52, EXEGGUTOR, GOLD_BERRY, EGG_BOMB, MEGA_DRAIN, SLUDGE_BOMB, REFLECT
	db 46, ESPEON,  GOLD_BERRY,   SAND_ATTACK, QUICK_ATTACK, SWIFT, PSYCHIC_M
	db 46, MR__MIME, GOLD_BERRY,  BARRIER, REFLECT, BATON_PASS, PSYCHIC_M
	db 48, ALAKAZAM, GOLD_BERRY,  RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 52, SLOWKING, GOLD_BERRY, PSYCHIC_M, SHADOW_BALL, BLIZZARD, EARTHQUAKE
...
BlaineGroup:
	...
	db 52, TYPHLOSION, FLAME_WHEEL, ROLLOUT, FIRE_PUNCH, SMOKESCREEN
	db 50, RAPIDASH,   QUICK_ATTACK, FIRE_SPIN, FURY_ATTACK, FIRE_BLAST
	db 52, CHARIZARD, FLAMETHROWER, WING_ATTACK, BITE, OUTRAGE
	db 55, NINETALES, HYPNOSIS, FIRE_SPIN, DIG, TOXIC
