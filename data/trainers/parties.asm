...
WhitneyGroup:
	...
	db 20, SNORLAX, NO_ITEM,  BELLY_DRUM, AMNESIA, HEADBUTT, DYNAMICPUNCH
	db 17, MEOWTH, NO_ITEM, BITE, HYPNOSIS, GROWL, SCRATCH
...
BugsyGroup:
	...
	db 12, KAKUNA, BERRY,    POISON_STING, STRING_SHOT, HARDEN, NO_MOVE
	db 12, PINECO, BERRY, PROTECT, PIN_MISSILE, FLAIL, SELFDESTRUCT, 
...
MortyGroup:
	...
	db 21, GASTLY,   BERRY,  LICK, SPITE, PSYWAVE, CURSE
	db 21, HAUNTER,  BERRY,  HYPNOSIS, ZAP_CANNON, CURSE, NIGHT_SHADE
	...
	db 23, HAUNTER,  BERRY,  SPITE, MEAN_LOOK, CURSE, NIGHT_SHADE
...
ChuckGroup:
	...
	db 29, MACHAMP, BLACKBELT_I, SEISMIC_TOSS, ROLLING_KICK, LIGHT_SCREEN, THIEF
	db 27, HERACROSS, BERRY, ENDURE, HORN_ATTACK, ROCK_SMASH, COUNTER
...
ClairGroup:
	...
	db 37, DRAGONAIR, GOLD_BERRY, TWISTER, THUNDER_WAVE, SLAM, DRAGONBREATH
	db 40, KINGDRA, MYSTIC_WATER, OCTAZOOKA, SURF, HYPER_BEAM, DRAGON_RAGE
	db 41, GYARADOS, GOLD_BERRY,  ICY_WIND, FIRE_BLAST, ZAP_CANNON, BITE
	db 43, CHARIZARD, GOLD_BERRY, OUTRAGE, WING_ATTACK, STEEL_WING, FLAMETHROWER
	db 42, TYRANITAR, GOLD_BERRY, ANCIENTPOWER, BITE, ROCK_SLIDE, DRAGONBREATH
	db 45, DRAGONITE, DRAGON_FANG, DRAGONBREATH, THUNDERBOLT, FLY, HYPER_BEAM
...
ChampionGroup:
	...
	db 60, SKARMORY, GOLD_BERRY, STEEL_WING,DRILL_PECK,MUD_SLAP,AGILITY
	db -1 ; end

BrockGroup:
	; BROCK (1)
	db "BROCK@", TRAINERTYPE_MOVES
	db 45, GRAVELER,   FIRE_PUNCH, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db 46, RHYDON,    THUNDERPUNCH, ROCK_SLIDE, PURSUIT, MAGNITUDE
	db 44, SHUCKLE, 	SLUDGE_BOMB, ENCORE, ROLLOUT, SAFEGUARD
...
LtSurgeGroup:
	...
	db 46, AMPHAROS, GOLD_BERRY, COTTON_SPORE, LIGHT_SCREEN, THUNDERPUNCH, REFLECT
