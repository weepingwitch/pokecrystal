...
BrunoGroup:
	...
	db 43, POLIWRATH,  HYPNOSIS, SUBMISSION, ICE_PUNCH, DETECT, BUBBLEBEAM
...
KarenGroup:
	...
	;db 45, SNEASEL,    BITE, COUNTER, SPITE, REFLECT
	;db 42, TYRANITAR,  CRUNCH, ROCK_SLIDE, SCREECH, SANDSTORM
	;db 45, GENGAR,     LICK, THIEF, CURSE, DESTINY_BOND
