...
MortyGroup:
	...
	db 28, ARIADOS, SILVERPOWDER,  LEECH_LIFE, NIGHT_SHADE, DISABLE, SCARY_FACE
	db 22, UMBREON, BERRY, BITE, SHADOW_BALL, SAND_ATTACK, CHARM
	db 28, HAUNTER,  BERRY,  SPITE, MEAN_LOOK, CURSE, NIGHT_SHADE
	db 24, GENGAR,   NO_ITEM,  HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
