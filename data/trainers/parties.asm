...
WillGroup:
	...
	db 45, XATU,    GOLD_BERRY,   GIGA_DRAIN, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	db 46, HYPNO,       QUICK_CLAW, DISABLE, HYPNOSIS, PSYCHIC_M, DREAM_EATER
	db 47, GIRAFARIG, GOLD_BERRY, BEAT_UP, PSYBEAM, CONFUSION, AGILITY
	db 47, SLOWKING,  MIRACLEBERRY,  EARTHQUAKE, SHADOW_BALL, HEADBUTT, PSYCHIC_M
	db 48, ALAKAZAM, TWISTEDSPOON,    RECOVER, FUTURE_SIGHT, DISABLE,PSYBEAM
	db 45, ESPEON, GOLD_BERRY, BITE, PSYCHIC_M, IRON_TAIL, SHADOW_BALL
	db -1 ; end
