...
WhitneyGroup:
	...
	db 24, FURRET, BERRY, QUICK_ATTACK, DEFENSE_CURL, DOUBLE_EDGE, FOCUS_ENERGY 
	db 24, GIRAFARIG, BERRY, STOMP, FUTURE_SIGHT, CONFUSION, AMNESIA
	db 24, RATICATE, QUICK_CLAW, QUICK_ATTACK, HYPER_FANG, SCARY_FACE, TAIL_WHIP
	db 25, SNORLAX, NO_ITEM,  BELLY_DRUM, AMNESIA, HEADBUTT, DYNAMICPUNCH
	db 26, MEOWTH, NO_ITEM, BITE, HYPNOSIS, GROWL, SCRATCH
	db 30, MILTANK,  LEFTOVERS,  ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end
...
MortyGroup:
	...
	db 29, GASTLY,   BERRY,  LICK, SPITE, PSYWAVE, CURSE
	db 30, HAUNTER,  BERRY,  HYPNOSIS, ZAP_CANNON, CURSE, NIGHT_SHADE
	db 32, ARIADOS, SILVERPOWDER,  LEECH_LIFE, NIGHT_SHADE, DISABLE, SCARY_FACE
	db 34, UMBREON, BERRY, BITE, SHADOW_BALL, SAND_ATTACK, CHARM
	db 35, HAUNTER,  BERRY,  SPITE, MEAN_LOOK, CURSE, NIGHT_SHADE
	db 36, GENGAR,   NO_ITEM,  HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
...
PryceGroup:
	...
	db 37, JYNX, BERRY, ICE_PUNCH, PSYCHIC_M, LOVELY_KISS, LICK
	db 38, DEWGONG,  BERRY,  HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 41, DELIBIRD, LEFTOVERS, PRESENT, ICE_BEAM, DETECT, SWAGGER
	db 40, PILOSWINE, NEVERMELTICE, ICY_WIND, ROCK_SLIDE, BITE, BLIZZARD
	db 39, SNEASEL, BERRY, BITE, ICE_PUNCH, FAINT_ATTACK, RAIN_DANCE
	db 41, CLOYSTER, BERRY, SPIKE_CANNON, CLAMP, AURORA_BEAM, PROTECT
	db -1 ; end
...
Rival2Group:
	...
	db 68, JOLTEON, HI_JUMP_KICK, THUNDER, SHADOW_BALL, RAIN_DANCE
	db 69, VAPOREON, BITE, HYDRO_PUMP, AURORA_BEAM, PSYCHIC_M
	db 70, EEVEE, EARTHQUAKE, BITE, TAKE_DOWN, HYPER_BEAM
	db -1 ; end
...
RedGroup:
	...
	db 73, MEWTWO,     DYNAMICPUNCH, ICE_BEAM, PSYCHIC_M, RECOVER
...
BlueGroup:
	...
	db 68, POLIWRATH,   SUBMISSION, HYPNOSIS, BODY_SLAM, HYDRO_PUMP
	db 68, VICTREEBEL,  SLEEP_POWDER, RAZOR_LEAF, SLUDGE_BOMB, GIGA_DRAIN
	db 68, ARCANINE,   SLEEP_TALK, REST, FLAMETHROWER, EXTREMESPEED
	db -1 ; end
