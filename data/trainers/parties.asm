...
WhitneyGroup:
	...
	db 18, FURRET, BERRY, QUICK_ATTACK, DEFENSE_CURL, DOUBLE_EDGE, FOCUS_ENERGY 
	db 18, GIRAFARIG, BERRY, STOMP, FUTURE_SIGHT, CONFUSION, AMNESIA
	...
	db 24, MILTANK,  LEFTOVERS,  ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end
...
MortyGroup:
	...
	db 22, GASTLY,   BERRY,  LICK, SPITE, PSYWAVE, CURSE
	db 24, HAUNTER,  BERRY,  HYPNOSIS, ZAP_CANNON, CURSE, NIGHT_SHADE
	db 25, ARIADOS, SILVERPOWDER,  LEECH_LIFE, NIGHT_SHADE, DISABLE, SCARY_FACE
	db 23, UMBREON, BERRY, BITE, SHADOW_BALL, SAND_ATTACK, CHARM
...
ChuckGroup:
	...
	db 27, PRIMEAPE,  BERRY, COUNTER, RAGE, KARATE_CHOP, FURY_SWIPES
	db 28, HITMONTOP, QUICK_CLAW, RAPID_SPIN, MACH_PUNCH, ROLLING_KICK, PURSUIT
	db 31, MACHAMP, BLACKBELT_I, SEISMIC_TOSS, ROLLING_KICK, LIGHT_SCREEN, THIEF
	db 29, HERACROSS, BERRY, ENDURE, HORN_ATTACK, ROCK_SMASH, COUNTER
	db 30, POLIWRATH, NO_ITEM, HYPNOSIS, SURF, SUBMISSION, ICE_PUNCH
	db 29, GENGAR, BERRY, DYNAMICPUNCH, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH
	db -1 ; end
