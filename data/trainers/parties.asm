...
WhitneyGroup:
	...
	db 20, FURRET, BERRY, QUICK_ATTACK, DEFENSE_CURL, DOUBLE_EDGE, FOCUS_ENERGY 
	db 20, GIRAFARIG, BERRY, STOMP, FUTURE_SIGHT, CONFUSION, AMNESIA
	db 20, RATICATE, QUICK_CLAW, QUICK_ATTACK, HYPER_FANG, SCARY_FACE, TAIL_WHIP
	db 21, SNORLAX, NO_ITEM,  BELLY_DRUM, AMNESIA, HEADBUTT, DYNAMICPUNCH
	db 19, MEOWTH, NO_ITEM, BITE, HYPNOSIS, GROWL, SCRATCH
	db 28, MILTANK,  LEFTOVERS,  ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end
...
MortyGroup:
	...
	db 24, GASTLY,   BERRY,  LICK, SPITE, PSYWAVE, CURSE
	db 25, HAUNTER,  BERRY,  HYPNOSIS, ZAP_CANNON, CURSE, NIGHT_SHADE
	db 25, ARIADOS, SILVERPOWDER,  LEECH_LIFE, NIGHT_SHADE, DISABLE, SCARY_FACE
	db 26, UMBREON, BERRY, BITE, SHADOW_BALL, SAND_ATTACK, CHARM
	db 26, HAUNTER,  BERRY,  SPITE, MEAN_LOOK, CURSE, NIGHT_SHADE
	db 30, GENGAR,   NO_ITEM,  HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
