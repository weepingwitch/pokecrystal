...
WillGroup:
	...
	db 45, CLEFABLE, POLKADOT_BOW, MOONBLAST, MOONLIGHT, METRONOME, SWEET_KISS
	db 45, GRANBULL, GOLD_BERRY, ICE_PUNCH, SHADOW_BALL, CHARM, CRUNCH
	db 46, WIGGLYTUFF, GOLD_BERRY, DAZZLINGLEAM, DOUBLE_EDGE, FAINT_ATTACK, THUNDER
	db 45, AZUMARILL, GOLD_BERRY, LIGHT_SCREEN, BUBBLEBEAM, ROLLOUT, SURF 
	db 45, MR__MIME, GOLD_BERRY, DAZZLINGLEAM, PSYBEAM, ENCORE, FIRE_PUNCH
	db 46, TOGETIC, GOLD_BERRY, MOONBLAST, DRAININGKISS, MIRROR_MOVE,SOLARBEAM
	db -1 ; end
...
BrunoGroup:
	...
	db 45, PRIMEAPE,  CROSS_CHOP, BEAT_UP, THUNDERPUNCH, FOCUS_ENERGY
	db 42, HITMONTOP,  RAPID_SPIN, ROLLING_KICK, DIG, DETECT
	db 43, POLIWRATH,  HYPNOSIS, SUBMISSION, ICE_PUNCH, BUBBLEBEAM
	db 42, HITMONLEE,  SWAGGER, ROLLING_KICK, HI_JUMP_KICK, ENDURE
...
KarenGroup:
	...
	db 44, MILTANK,     MILK_DRINK, BODY_SLAM, HYPER_BEAM, ICE_PUNCH
	db 45, ESPEON,      BITE, PSYCHIC_M, ZAP_CANNON, FOCUS_ENERGY
	db 45, TOGEPI,   	DOUBLE_EDGE, DRAININGKISS, FIRE_BLAST, ENCORE
	db 46, PIDGEOT, 	AGILITY, FLY, STEEL_WING, WHIRLWIND
	db 45, CELEBI,		FUTURE_SIGHT,ANCIENTPOWER,GIGA_DRAIN,PERISH_SONG
...
KogaGroup:
	...
	db 48, VENUSAUR, MIRACLE_SEED, TOXIC, GIGA_DRAIN, SLEEP_POWDER, RAZOR_LEAF
	db 49, VENOMOTH,  GOLD_BERRY, LEECH_LIFE, GUST, PSYCHIC_M, TOXIC
	db 48, MUK,   POISON_BARB  ,   MINIMIZE, THUNDER, SLUDGE_BOMB, TOXIC
	db 50, NIDOQUEEN, KINGS_ROCK, BITE, BODY_SLAM, POISON_STING, DISABLE
	db 47, CROBAT, QUICK_CLAW,    STEEL_WING, BITE, WING_ATTACK, TOXIC
	db 50, ARBOK, GOLD_BERRY, ACID, EARTHQUAKE, BITE, GLARE
...
ChampionGroup:
	...
	db 50, ARTICUNO,QUICK_CLAW,ICE_BEAM,STEEL_WING,AGILITY,REFLECT
	db 50, ZAPDOS, QUICK_CLAW,LIGHT_SCREEN,DRILL_PECK,THUNDERBOLT,AGILITY
	db 50, MOLTRES,QUICK_CLAW, SAFEGUARD, FLAMETHROWER,AGILITY,FLY
	db 50, PIDGEOT, SHARP_BEAK, MUD_SLAP,WING_ATTACK,FLY,WHIRLWIND
	db 50, DODRIO, GOLD_BERRY, TRI_ATTACK, DRILL_PECK, RAGE, ENDURE
	db 50, SKARMORY, GOLD_BERRY, STEEL_WING,DRILL_PECK,MUD_SLAP,AGILITY
	db -1 ; end
