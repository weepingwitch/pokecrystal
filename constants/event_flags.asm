...
; Johto hidden items
	...
	const EVENT_SAFARIZONE_BALL
	const EVENT_SAFARIZONE2_BALL
...
; Phone events
	...
	const EVENT_GOT_HOTSAUCE
	const EVENT_BEVERLY_ASKED_FOR_PHONE_NUMBER
	const EVENT_POKEMANSION_BALL
...
; Burglar
	...
	const EVENT_BEAT_POKEFANF_MILF
; Biker
...
; Beauty
	...
	const EVENT_BEAT_BEAUTY_ELIZA
	const EVENT_BEAT_PICNICKER_SARA
...
; Kimono Girl
	const EVENT_BEAT_SCIENTIST_ELM
