...
CinnabarIsland_MapEvents:
	...
	warp_event 7, 3, POKEMON_MANSION, 1 ;2

	def_coord_events

	def_bg_events
	bg_event 12, 11, BGEVENT_READ, CinnabarIslandPokecenterSign
	bg_event  5, 9, BGEVENT_READ, CinnabarIslandGymSign
	bg_event  9,  13, BGEVENT_READ, CinnabarIslandSign
	bg_event  11,  16, BGEVENT_ITEM, CinnabarIslandHiddenRareCandy

	def_object_events
	object_event  15,  4, SPRITE_BLUE, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CinnabarIslandBlue, EVENT_BLUE_IN_CINNABAR
