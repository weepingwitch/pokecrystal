	...
	const GOLDENRODDEPTSTOREB1F_BLACK_BELT4
...
GoldenrodDeptStoreB1FBlackBelt4Script:
	faceplayer
	checkevent EVENT_ZELDA0
	iftrue .alreadygiven
	opentext
...
.alreadygiven
	opentext
	writetext GivenBlahaj
	waitbutton
	closetext
	end

GiveBlahaj:
	text "Hey, I bought too"
	line "many of these."
...
GivenBlahaj:
	text "Hugging it makes"
	line "me feel so calm!"
	done
...
GoldenrodDeptStoreB1F_MapEvents:
	...
	object_event  4,  8, SPRITE_FISHER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, GoldenrodDeptStoreB1FBlackBelt2Script, -1
	...
	object_event  11, 7, SPRITE_FISHER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 1, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, GoldenrodDeptStoreB1FBlackBelt4Script, -1
